...
function Todo() {
  ...
  function waitingClick(id) {
    ...
    // setTodosRaw(todosRaw); // ok, but state is not changed
    setTodosRaw([...todosRaw]); // ok, and is state changed
  }
  ...
  function addClick(id, title) {
    ...
    /*todosRaw.push(newTodo); // ok, but state is not changed */
    setTodosRaw([...todosRaw, newTodo]); // ok, and is state changed
  }
    ...
    <div className="todo-container">
      <Modal show={show} onHide={handleClose} animation={false}>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={handleClose}>
            <span className="bi bi-x-lg"></span>&nbsp;Close
          </Button>
      ...
      <table className="table table-striped todo-table">
        ...
        <tbody>
          {
            // itemsPerPage = 5
            // curPage = 1 --> 2 --> 3 --> ... --> numPages
            // items (human) = [1,2,3,4,5] --> [6,...,10] --> [11,...,15]
            // items (js) = [0,1,2,3,4] --> [5,...,9] --> [10,...14]
            // items (js) = [min,...,max]
