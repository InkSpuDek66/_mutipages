...
// import styles
import "./Navbar.css";
function Navbar({ tab, setTab, setToken, products, carts, role }) {
  return (
    <div className="navbar-container">
      ...
      <Link to={"/tax"}>
        <button
          className={"btn " + (tab === "tax" ? " btn-primary" : "btn-outline-primary")}
          onClick={() => setTab("tax")}>
          Tax
        </button>
      </Link>
      ...
      <Link to={"/carts"}>
        <button
          className={"position-relative btn " + (tab === "carts" ? " btn-primary" : "btn-outline-primary")}
